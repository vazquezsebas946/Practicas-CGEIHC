...
int main()
{
	...
	//Cargamos los modelos de mi carro
	chasis = Model();
	cofre = Model();
	llanta1 = Model();
	llanta2 = Model();
	...
	while (!mainWindow.getShouldClose())
	{
		...
		glm::vec3 luzcarro = glm::vec3(mainWindow.getarticulacion3(), 1.0f, -8.5f);
		glm::vec3 luzcarro2 = glm::vec3(-mainWindow.getarticulacion4(), 1.0f, -8.5);
