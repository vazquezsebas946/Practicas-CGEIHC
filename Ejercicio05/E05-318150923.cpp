...
Camera camera;
Model goddard_cuerpo, goddard_craneo, goddard_mandibula, pata1, pata2, pata3, pata4;
...
int main()
{
	...
	goddard_craneo = Model();
	goddard_mandibula = Model();
	goddard_cuerpo.LoadModel("Models/goddard_cuerpo.obj");//El obj no necesita rotaciones extras, el dae y fbx necesitan rotar.
	goddard_craneo.LoadModel("Models/goddard_craneo.obj");
	goddard_mandibula.LoadModel("Models/goddard_mandibula.obj");
	pata1.LoadModel("Models/goddard_pata1.obj");
	pata2.LoadModel("Models/goddard_pata2.obj");
	pata3.LoadModel("Models/goddard_pata3.obj");
	pata4.LoadModel("Models/goddard_pata4.obj");
