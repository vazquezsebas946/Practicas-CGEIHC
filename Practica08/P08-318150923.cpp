...
int main()
{
	...
	anvorguesa = Model();
	anvorguesa.LoadModel("Models/hamburguesa.obj");
	puerta = Model();
	puerta.LoadModel("Models/puertarejas.obj");
	cartel = Model();
	...
	spotLights[1] = SpotLight(1.0f, 0.0f, 1.0f,
		...
		0.0f, 5.0f, 10.0f,
		1.0f, 0.0f, 0.0005f,
		40.0f);//que tan amplia es la zona de iluminacion, sirve para acotar la luz
	spotLightCount++;
	
	//Luz trasera del carro
	spotLights[2] = SpotLight(0.0f, 0.0f, 1.0f, //rojo, verde y azul
		1.0f, 2.0f, //ambiental y difuso
		-40.0f, 6.0f, -3.0f,//pocision
		-10.0f, 2.0f, 0.0f,//direccion
		1.0f, 0.0f, 0.005f, //valores de la ecuacion cuadratica
		40.0f);//Angulo de apertura del cono del spotlight
	spotLightCount++;
	...
	while (!mainWindow.getShouldClose())
	{
		...
		glm::vec3 luzcarro = glm::vec3(33.0f+mainWindow.getarticulacion2(), 2.0f, 1.5f);
		glm::vec3 luzcarro2 = glm::vec3(-40.0f+mainWindow.getarticulacion3(), 6.0f, -3.0f);
		...
		if (mainWindow.getarticulacion1() > 0.0) {
			...
			spotLights[2].SetPos(luzcarro);
			spotLights2[2].SetPos(luzcarro2);
		}

		if (mainWindow.getarticulacion7() > 0.0) {
		...
		//Puerta 
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, 28.0));
		...
		//cartel
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 13.0f, 28.0));
		...
		model = glm::scale(model, glm::vec3(2.0f, 2.0f, 2.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		anvorguesa.RenderModel();

		//--------------------------COCHE-------------------------------//
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(25.0f, 0.2f, -3.0f));
