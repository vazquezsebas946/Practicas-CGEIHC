...
void MeshColor::CreateMeshColor(GLfloat *vertices, unsigned int numOfVertices) //función de creación de VAO, VBO, IBO
{
	...
	glVertexAttribPointer(0, 3, GL_FLOAT, GL_FALSE, 6*sizeof(vertices[0]), 0); //6=numero de lineas por renglon
...
void MeshColor::RenderMeshColor() //Función de Render (Dibujado)
{
	...
	glBindVertexArray(0);//Cuando tenemos indices, dibujamos con dlDrawElements, sin indices, es drawArrays
}
